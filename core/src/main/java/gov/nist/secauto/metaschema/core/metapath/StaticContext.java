...
public final class StaticContext {
  ...
  /**
   * Get the prefix associated with the provided {@code namespace} as a string, if any is bound.
   *
   * @param namespace
   *          the namespace
   * @return the prefix string bound to the prefix, or {@code null} if no prefix is bound to the
   *         namespace
   */
  @Nullable
   ...
   * <ol>
   * <li>Lookup the prefix using the namespaces registered with the static context.
   * <li>Lookup the prefix in the well-known namespaces.
   * </ol>
   * <p>
   * If an empty prefix is provided, the {@link MetapathConstants#NS_METAPATH} namespace will be used.
   *
   * @param name
   *          the name
   * @return the parsed qualified name
   * @throws StaticMetapathException
   *           with the code {@link StaticMetapathException#PREFIX_NOT_EXPANDABLE} if a non-empty
   *           prefix is provided
   */
  @NonNull
   ...
   * <p>
   * This method will first attempt to expand the namespace prefix for a lexical QName. A
   * {@link StaticMetapathException} with the code
   * {@link StaticMetapathException#PREFIX_NOT_EXPANDABLE} if the prefix is not know to the static
   * context.
   * <p>
   * Once the qualified name has been produced, the atomic type will be retrieved from the available
   * atomic types. If the atomic type was not found, a {@link StaticMetapathException} with the code
   * {@link StaticMetapathException#UNKNOWN_TYPE} will be thrown. Otherwise, the type information is
   * returned for the matching atomic type.
   *
   * @param name
   *          the namespace qualified or lexical name of the data type.
   * @return the data type information
   * @throws StaticMetapathException
   *           with the code {@link StaticMetapathException#PREFIX_NOT_EXPANDABLE} if the lexical name
   *           was not able to be expanded or the code
   *           {@link StaticMetapathException#NO_FUNCTION_MATCH} if a matching type was not found
   */
  @NonNull
   ...
   * @return the type
   * @throws StaticMetapathException
   *           with the code {@link StaticMetapathException#UNKNOWN_TYPE} if the type was not found
   */
  @NonNull
   ...
   * <li>Lookup the prefix in the well-known namespaces.
   * </ol>
   * If an empty prefix is provided, the {@link Builder#defaultFunctionNamespace(String)} namespace
   * will be used.
   *
   * @param name
   *          the name
  ...
  /**
   * Checks if the provided prefix is not-empty, which means the prefix was not resolvable.
   *
   * @param prefix
   ...
   * context.
   * <p>
   * Once the qualified name has been produced, the function will be retrieved from the available
   * functions. If the function was not found, a {@link StaticMetapathException} with the code
   * {@link StaticMetapathException#UNKNOWN_TYPE} will be thrown. Otherwise, the data type information
   * is returned for the matching data type.
   *
   * @param name
   ...
   *           with the code {@link StaticMetapathException#PREFIX_NOT_EXPANDABLE} if the lexical name
   *           was not able to be expanded or the code
   *           {@link StaticMetapathException#NO_FUNCTION_MATCH} if a matching function was not found
   */
  @NonNull
   ...
   * <li>Lookup the prefix in the well-known namespaces.
   * </ol>
   * If an empty prefix is provided, the {@link XMLConstants#NULL_NS_URI} namespace will be used.
   *
   * @param name
   *          the name
   * @return the parsed qualified name
   ...
   * <li>Lookup the prefix in the well-known namespaces.
   * </ol>
   * If an empty prefix is provided, the {@link Builder#defaultModelNamespace(String)} namespace will
   * be used.
   *
   * @param name
   *          the name
  ...
  /**
   * Indicates if a name match should use a wildcard for the namespace if the namespace does not have
   * a value and the default model namespace is {@code null}.
   *
