...
import gov.nist.secauto.metaschema.core.model.xml.impl.XmlbeansMarkupWriter;
...
class XmlbeansMarkupVisitorTest {
  ...
  private static String testMarkupLine(@NonNull String markdown) throws IOException {
    ...
    try (XmlCursor cursor = xmlData.newCursor()) {
      ...
      XmlbeansMarkupWriter.visit(markup, MetaschemaConstants.METASCHEMA_NAMESPACE, cursor);
